                    ...
                    <v-row>
                        ...
                        >
                            ...
                            >
                                ...
                                <v-combobox
                                        v-model="net.default.address"
                                        :items="net.default.address"
                                        label="IP subnet for this network (ex. 10.10.10.0/24)"
                                        :rules="[ v => !!v || 'Subnet is required', ]"
                                        multiple
                                        chips
                                        persistent-hint
                                        required
                                ...
                                <v-switch
                                        v-model="net.default.upnp"
                                        color="success"
                                        inset
                                        label="Enable UPnP where possible"
                               />
                                    <v-switch
                                        v-model="net.default.enableDns"
                                        color="success"
                                        inset
                        ...
                        >
                            ...
                            >
                                <v-text-field
                                        v-model="net.id"
                                        label="Id"
                                        :rules="[ v => !!v || 'Net id is required',]"
                                        required
                                />
                                <v-text-field
                                        v-model="net.netName"
                                        label="Friendly name"
                                        :rules="[ v => !!v || 'Net name is required',]"
                                        required
                                />
                                <v-text-field
                                        v-model="net.description"
                                ...
                                <v-combobox
                                    ...
                                    label="DNS servers for this net"
                                    multiple
                                    dark
                                >
                                    <template v-slot:selection="{ attrs, item, select, selected }">
                ...
                <v-expansion-panel-header dark>Advanced configuration</v-expansion-panel-header>
                    <v-expansion-panel-content>
                        <div class="d-flex flex-no-wrap justify-space-between">
                            <v-col cols="12">
                                <v-text-field
                                        v-model="net.default.presharedKey"
                                        label="Preshared Key"
                                />
                                <v-combobox
                                        v-model="net.default.allowedIPs"
                                        chips
                                        hint="Write IPv4 or IPv6 CIDR and hit enter"
                                        label="Allowed IPs"
                                        multiple
